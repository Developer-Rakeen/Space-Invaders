...
PLAYER_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('D:\\GoogleDrive\\My own Python Programmes\\i.s', 'player.png'))
...
ENEMY_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('D:\\GoogleDrive\\My own Python Programmes\\i.s', 'enemy.png'))
...
SPACE = pygame.transform.scale(pygame.image.load(
    os.path.join('D:\\GoogleDrive\\My own Python Programmes\\i.s', 'space.jpg')), (WIDTH, HEIGHT))
SP = pygame.transform.scale(pygame.image.load(
    os.path.join('D:\\GoogleDrive\\My own Python Programmes\\i.s', 'sp.png')), (WIDTH, HEIGHT))
SI_IMAGE = pygame.image.load(
    os.path.join('D:\\GoogleDrive\\My own Python Programmes\\i.s', 'si.png'))
...
PLAYER_BULLET_FIRE_SOUND = pygame.mixer.Sound(
    os.path.join('D:\\GoogleDrive\\My own Python Programmes\\i.s', 'player gun.mp3'))
E_BULLET_FIRE_SOUND = pygame.mixer.Sound(
    os.path.join('D:\\GoogleDrive\\My own Python Programmes\\i.s', 'enemy gun.mp3'))
